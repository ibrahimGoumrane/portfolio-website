...
const projects = [
  {
    ...
    technologies: ["Python", "OpenAI API", "FAISS", "Sentence Transformers", "Playwright", "AsyncIO"],
    date: "07/2025 - 08/2025",
    role: "AI Engineer",
    isVideo: false,
    github: "https://github.com/ibrahimgoumrane",
  },
  {
    id: 2,
    ...
    image: "/ai-exam-grading-automated-correction-system.jpg",
    technologies: ["Django REST", "OCR/Tesseract", "OpenAI API", "Sentence Transformers", "SQLite"],
  ...
  },
  {
    ...
    image: "/facial-recognition-attendance-tracking-system.jpg",
    technologies: ["Django", "face_recognition", "Redis", "Next.js", "Docker", "Tailwind"],
  ...
  },
  {
    ...
    role: "ML Researcher",
    isVideo: false,
    kaggle: "https://www.kaggle.com/ibrahimgoumrane",
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            {t("ai.title")} <span className="text-secondary">{t("ai.highlight")}</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl">{t("ai.description")}</p>
          <div className="h-1 w-20 bg-gradient-to-r from-secondary to-accent rounded-full mt-4"></div>
        </div>
