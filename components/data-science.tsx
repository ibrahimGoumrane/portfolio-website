...
const projects = [
  {
    ...
    isVideo: false,
    github: "https://github.com/ibrahimGoumrane/web_sales_analytic_pipeline",
  },
  {
    id: 2,
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            {t("data.title")}{" "}
            <span className="text-accent">{t("data.highlight")}</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl">
            {t("data.description")}
          </p>
          <div className="h-1 w-20 bg-linear-to-r from-accent to-primary rounded-full mt-4"></div>
        </div>
